...
```text
.
├── Reverse/          # Binaries, de-compiled code, and solving scripts
├── Forensics/        # Artifacts and investigation logs
├── Web/              # Exploit payloads and walkthroughs
├── Misc/             # General challenges
├── Ai/             # Ai challenges
├── Source Code/             # coding challenges
